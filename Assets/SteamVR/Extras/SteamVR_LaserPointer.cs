...
public class SteamVR_LaserPointer : MonoBehaviour {
  ...
  private void Start() {
    ...
    var col = pointer.GetComponent<BoxCollider>();
    if (addRigidBody) {
  ...
  private void Update() {
    ...
    if (controller != null && controller.padPressed) { pointer.transform.localScale = new Vector3(thickness*5f, thickness*5f, dist); }
    else { pointer.transform.localScale = new Vector3(thickness, thickness, dist); }
